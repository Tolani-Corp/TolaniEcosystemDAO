...
export const DAO_PAGES: DAOPageContext[] = [
  ...
  },
  {
    ...
    href: "/bounties",
    icon: Target,
    description: "Coordinate open construction jobs, DAO tasks, crews, milestones, and task rewards.",
    keywords: [
      "bounty",
      "tasks",
      "work",
  ...
  },
  {
    ...
    href: "/dao-evidence",
    icon: ClipboardCheck,
    description: "Review Tolani Labs evidence packets for DAO proposals, token actions, and TUT rewards.",
    keywords: [
      "labs",
      "evidence",
      "esg",
